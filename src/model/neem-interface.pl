:- module(model_neem_interface,
	[
	mem_episode_start/10,
	mem_episode_start/11,
	mem_clear_memory/0,
	mem_episode_stop/1,
	mem_episode_stop/2,
	...
	mem_event_end/1,
	add_subaction_with_task/3,
	mem_event_begin/1,
	belief_perceived_at/4,
	mem_tf_set/5,
	mem_tf_get/4,
	mem_tf_get/5,
	add_participant_with_role/3,
	add_parameter/3,
	add_grasping_parameter/2,
	add_comment/2,
	ros_logger_start/0,
	ros_logger_stop/0
	]).
...
mem_episode_start(Episode,Action,ActionType, EnvOwl, EnvOwlIndiName, EnvUrdf, EnvUrdfPrefix, AgentOwl, AgentOwlIndiName, AgentUrdf) :-
    get_time(StartTime),
    mem_episode_start(Episode, Action,ActionType,EnvOwl, EnvOwlIndiName, EnvUrdf, EnvUrdfPrefix, AgentOwl, AgentOwlIndiName, AgentUrdf, StartTime).
...
mem_episode_start(Episode, Action,ActionType, EnvOwl, EnvOwlIndiName, EnvUrdf, EnvUrdfPrefix, AgentOwl, AgentOwlIndiName, AgentUrdf, StartTime) :-
    ...
    kb_project([
        ...
        new_iri(Task, ActionType), has_type(Task,ActionType), executes_task(Action,Task),
...
add_subaction_with_task(ParentAction,SubAction,TaskType) :-
    ...
    kb_project([
        ...
        holds(ParentAction,dul:hasConstituent,SubAction),
